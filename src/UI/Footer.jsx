function Footer() {
  ...
  return (
    <footer className="flex justify-around items-center bg-red-400 px-4 py-1">
      <a href="https://www.linkedin.com/in/anshsavadatti2004/" className={className}>ansh_savadatti</a>
      <p>&copy; Eventify</p>
      <a href="https://github.com/AnshRiteshSavadatti" className={className}>GitHub</a>
    </footer>
  );
}
